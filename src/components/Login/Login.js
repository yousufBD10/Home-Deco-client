...
const Login = () => {
  useTitle("Login")
  const { loginEmailPass, setLoading, sinInGoogle, GithubSignIn } =
      ...
      <div className="bg-white py-6 px-10 sm:max-w-md w-full ">
        ...
        <form onSubmit={handleLogin} className="">
          <div>
            <input
              type="email"
              className="focus:outline-none border-b w-full pb-2  placeholder-gray-500 my-8"
          ...
          <div className="flex justify-center my-6">
            <button
              type="submit"
              className=" rounded-full  p-3 w-full sm:w-56   bg-sky-600  text-white text-lg font-semibold "
            >
              Login
            </button>
          </div>
          ...
          <div className="flex">
            <button
              ...
              type="button"
              class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
